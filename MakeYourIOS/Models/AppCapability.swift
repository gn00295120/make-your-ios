...
enum AppCapability: String, Codable, CaseIterable, Hashable, Sendable {
    ...
    case microphoneRecordLocal = "microphone.recordLocal"
    case speechTranscribeOnDevice = "speech.transcribeOnDevice"
    ...
    var label: String {
        ...
        case .microphoneRecordLocal: "Local voice recording"
        case .speechTranscribeOnDevice: "On-device speech transcription"
    ...
    var symbol: String {
        ...
        case .microphoneRecordLocal: "mic.fill"
        case .speechTranscribeOnDevice: "text.bubble.fill"
